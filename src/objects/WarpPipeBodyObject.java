...
public class WarpPipeBodyObject extends LevelObject {
	...
	public WarpPipeBodyObject(String data,ConversionType type) throws Exception {
		super(data,type);
		
		defaultValues = new Object[] {ID,pallete,position,scale,rotation,enabled,visible,colour,parts};
	...
	void setupValues() {
		...
		parts = (objectData[8] == null) ? parts:(long) objectData[8].getValue();
		...
		if (objectData[8] == null) { objectData[8] = new IntegerType(Utility.integerToString(parts));}
	}
