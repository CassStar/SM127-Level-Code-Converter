...
public class BooObject extends LevelObject {
	...
	public BooObject(String data,ConversionType type) throws Exception {
		super(data,type);
		
		defaultValues = new Object[] {ID,pallete,position,scale,rotation,enabled,visible,speed};
	...
	void setupValues() {
		...
		speed = (objectData[7] == null) ? speed:(double) Double.valueOf(String.valueOf(objectData[7].getValue()));
		...
		if (objectData[7] == null) { objectData[7] = new FloatType(Utility.floatToString(speed));}
	}
