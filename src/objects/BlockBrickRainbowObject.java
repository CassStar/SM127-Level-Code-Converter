...
public class BlockBrickRainbowObject extends LevelObject {
	...
	public BlockBrickRainbowObject(String data,ConversionType type) throws Exception {
		super(data,type);
		
		defaultValues = new Object[] {ID,pallete,position,scale,rotation,enabled,visible,coins};
	...
	void setupValues() {
		...
		coins = (objectData[7] == null) ? coins:(long) objectData[7].getValue();
		...
		if (objectData[7] == null) { objectData[7] = new IntegerType(Utility.integerToString(coins));}
	}
