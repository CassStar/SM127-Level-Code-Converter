...
public class PropellerObject extends LevelObject {
	...
	public PropellerObject(String data,ConversionType type) throws Exception {
		...
		defaultValues = new Object[] {ID,pallete,position,scale,rotation,enabled,visible,propellerSpeed};
	...
	void setupValues() {
		...
		propellerSpeed = (objectData[7] == null) ? propellerSpeed:(long) objectData[7].getValue();
		...
		if (objectData[7] == null) { objectData[7] = new IntegerType(Utility.integerToString(propellerSpeed));}
	}
