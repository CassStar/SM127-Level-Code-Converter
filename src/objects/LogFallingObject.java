...
public class LogFallingObject extends LevelObject {
	
	public int ID,pallete = 0;
	public double[] position = {0,0},scale = {1,1};
	public double rotation = 0;
	public boolean enabled = true,visible = true,fallOnTouch = false;
	
	public LogFallingObject(String data,ConversionType type) throws Exception {
		super(data,type);
		
		defaultValues = new Object[] {ID,pallete,position,scale,rotation,enabled,visible,fallOnTouch};
	...
	void setupValues() {
		...
		fallOnTouch = (objectData[7] == null) ? fallOnTouch:(boolean) objectData[7].getValue();
		...
		if (objectData[7] == null) { objectData[7] = new BooleanType(Utility.booleanToString(fallOnTouch));}
	}
