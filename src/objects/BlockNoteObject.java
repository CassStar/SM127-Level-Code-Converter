...
public class BlockNoteObject extends LevelObject {
	
	public int ID,pallete = 0;
	public long parts = 1,strongBouncePower = 650;
	public double[] position = {0,0},scale = {1,1};
	public double rotation = 0;
	public boolean enabled = true,visible = true;
	
	public BlockNoteObject(String data,ConversionType type) throws Exception {
		super(data,type);
		
		defaultValues = new Object[] {ID,pallete,position,scale,rotation,enabled,visible,parts,strongBouncePower};
	...
	void setupValues() {
		...
		strongBouncePower = (objectData[8] == null) ? strongBouncePower:(long) objectData[8].getValue();
		...
		if (objectData[8] == null) { objectData[8] = new IntegerType(Utility.integerToString(strongBouncePower));}
	}
