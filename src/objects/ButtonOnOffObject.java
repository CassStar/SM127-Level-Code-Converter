...
public class ButtonOnOffObject extends LevelObject {
	
	public int ID,pallete = 0;
	public double[] position = {0,0},scale = {1,1};
	public double rotation = 0;
	public boolean enabled = true,visible = true,switchMode = true;
	
	public ButtonOnOffObject(String data,ConversionType type) throws Exception {
		super(data,type);
		
		defaultValues = new Object[] {ID,pallete,position,scale,rotation,enabled,visible,switchMode};
	...
	void setupValues() {
		...
		switchMode = (objectData[7] == null) ? switchMode:(boolean) objectData[7].getValue();
		...
		if (objectData[7] == null) { objectData[7] = new BooleanType(Utility.booleanToString(switchMode));}
	}
