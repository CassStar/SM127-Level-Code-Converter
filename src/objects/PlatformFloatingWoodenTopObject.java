...
public class PlatformFloatingWoodenTopObject extends LevelObject {
	...
	public PlatformFloatingWoodenTopObject(String data,ConversionType type) throws Exception {
		super(data,type);
		
		defaultValues = new Object[] {ID,pallete,position,scale,rotation,enabled,visible,parts,physicsEnabled};
