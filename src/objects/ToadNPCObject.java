...
public class ToadNPCObject extends LevelObject {
	
	public int ID,pallete = 0;
	public long idleExpression,idleAction,speakingExpression,speakingAction,requiredShines;
	public double[] position,scale,spotsColour,coatColour;
	...
	public ToadNPCObject(String data,ConversionType type) throws Exception {
		super(data,type);
		setupValues();
	}
	...
	void setupValues() {
		...
		spotsColour = (double[]) objectData[19].getValue();
		coatColour = (double[]) objectData[20].getValue();
