...
public class TorchObject extends LevelObject {
	
	public int ID,pallete = 0;
	public double[] position = {0,0},scale = {1,1},colour = {1,1,0,1};
	public double rotation = 0;
	public boolean enabled = true,visible = true,isBackground = true;
	
	public TorchObject(String data,ConversionType type) throws Exception {
		super(data,type);
		
		defaultValues = new Object[] {ID,pallete,position,scale,rotation,enabled,visible,isBackground,colour};
	...
	void setupValues() {
		...
		isBackground = (objectData[7] == null) ? isBackground:(boolean) objectData[7].getValue();
		...
		if (objectData[7] == null) { objectData[7] = new BooleanType(Utility.booleanToString(isBackground));}
		if (objectData[8] == null) { objectData[8] = new ColourType(Utility.colourToString(colour));}
	}
}
