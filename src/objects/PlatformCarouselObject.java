...
public class PlatformCarouselObject extends LevelObject {
	
	public int ID,pallete = 0;
	public long parts = 4,platformCount = 4;
	...
	public PlatformCarouselObject(String data,ConversionType type) throws Exception {
		super(data,type);
		
		defaultValues = new Object[] {ID,pallete,position,scale,rotation,enabled,visible,parts,speed,radius,platformCount,colour,startAngle};
	...
	void setupValues() {
		...
		startAngle = (objectData[12] == null) ? startAngle:(double) Double.valueOf(String.valueOf(objectData[12].getValue()));
		...
		if (objectData[11] == null) { objectData[11] = new ColourType(Utility.colourToString(colour));}
		if (objectData[12] == null) { objectData[12] = new FloatType(Utility.floatToString(startAngle));}
	}
