...
public class CheepGoggleObject extends LevelObject {
	
	public int ID,pallete = 0;
	public double[] position = {0,0},scale = {1,1},colour = {0.16,0.87,0,1};
	public double rotation = 0;
	public boolean enabled = true,visible = true,rainbow = false;
	
	public CheepGoggleObject(String data,ConversionType type) throws Exception {
		super(data,type);
		
		defaultValues = new Object[] {ID,pallete,position,scale,rotation,enabled,visible,colour,rainbow};
