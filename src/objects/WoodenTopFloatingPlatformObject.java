...
public class WoodenTopFloatingPlatformObject extends LevelObject {
	...
	public WoodenTopFloatingPlatformObject(String data,ConversionType type) throws Exception {
		super(data,type);
		setupValues();
	}
