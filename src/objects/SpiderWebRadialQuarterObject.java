...
public class SpiderWebRadialQuarterObject extends LevelObject {
	...
	public SpiderWebRadialQuarterObject(String data,ConversionType type) throws Exception {
		super(data,type);
		
		defaultValues = new Object[] {ID,pallete,position,scale,rotation,enabled,visible};
