...
public class MushroomTopObject extends LevelObject {
	...
	public long strongBouncePower = 650;
	...
	public MushroomTopObject(String data,ConversionType type) throws Exception {
		...
		defaultValues = new Object[] {ID,pallete,position,scale,rotation,enabled,visible,colour,bouncy,strongBouncePower};
	...
	void setupValues() {
		...
		case 10:
			...
			strongBouncePower = (objectData[9] == null) ? strongBouncePower:(long) objectData[9].getValue();
