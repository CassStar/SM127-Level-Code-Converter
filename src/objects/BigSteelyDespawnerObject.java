...
public class BigSteelyDespawnerObject extends LevelObject {
	
	public int ID,pallete = 0;
	public long speedThreshold = 30;
	public double[] position = {0,0},scale = {1,1};
	public double rotation = 0;
	public boolean enabled = true,visible = true;
	
	public BigSteelyDespawnerObject(String data,ConversionType type) throws Exception {
		super(data,type);
		
		defaultValues = new Object[] {ID,pallete,position,scale,rotation,enabled,visible,speedThreshold};
	...
	void setupValues() {
		...
		speedThreshold = (objectData[7] == null) ? speedThreshold:(long) objectData[7].getValue();
		...
		if (objectData[7] == null) { objectData[7] = new IntegerType(Utility.integerToString(speedThreshold));}
	}
}
