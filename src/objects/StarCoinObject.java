...
public class StarCoinObject extends LevelObject {
	
	public int ID,pallete = 0;
	public long coinPlacedIndex = 0;
	public double[] position = {0,0},scale = {1,1};
	public double rotation = 0;
	public boolean enabled = true,visible = true;
	
	public StarCoinObject(String data,ConversionType type) throws Exception {
		super(data,type);
		
		defaultValues = new Object[] {ID,pallete,position,scale,rotation,enabled,visible,coinPlacedIndex};
	...
	void setupValues() {
		...
		coinPlacedIndex = (objectData[7] == null) ? coinPlacedIndex:(long) objectData[7].getValue();
		...
		if (objectData[7] == null) { objectData[7] = new IntegerType(Utility.integerToString(coinPlacedIndex));}
	}
